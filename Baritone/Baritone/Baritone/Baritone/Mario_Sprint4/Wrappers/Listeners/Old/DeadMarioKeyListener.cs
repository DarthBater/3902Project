...
{
    class DeadMarioKeyListener : KeyListener
    {

        public DeadMarioKeyListener(Sprint1 game) : base(game)
        {
        }
        ...
        {
            if (this.game.Mario.SheetState != States.MARIO_DEAD)
            {
                this.game.Mario.SetSheetState(States.MARIO_DEAD);
            }
        }
